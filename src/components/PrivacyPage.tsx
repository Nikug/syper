...
const PrivacyPage: Component = () => {
  return (
    <PageContainer>
      ...
      <p>
        You provide directly most of the data we collect by using Syper. We collect data when you:
      </p>
      <ul class="ul">
        <li>Sign up</li>
      ...
      <ul class="ul">
        <li>
          You can view your typing test result history and statistics calculated from the history
        </li>
      ...
      <p>
        ...
        from you automatically through cookies or similar technology. For further information, visit{' '}
        <a href="https://allaboutcookies.org" class="link">
          allaboutcookies.org
        </a>
      </p>
      <h2 class="h2 mt-8">How do we use cookies?</h2>
      <p>Syper uses cookies to provide a functionality. This includes the following functions:</p>
      <ul class="ul">
        <li>Store your settings</li>
        <li>Keep you signed in</li>
      </ul>
      <h2 class="h2 mt-8">How to manage cookies?</h2>
      <p>You can set your browser not to accept cookies. This can impact some features of Syper.</p>
      ...
      <p>
        For all questions about this privacy policy, or if you want to exercise your data protection
