...
import { personalBests, setPersonalBests } from '../StateManager'
import { DatabasePersonalBest, DatabaseTestResult } from '../supabaseTypes'
import { PersonalBestCategory } from '../types'
...
const testToCategory = (test: DatabaseTestResult): PersonalBestCategory => {
  return {
    textMode: test.textMode,
